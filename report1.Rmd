...
author: "Zheng Sun, Xingyang Lin, Shan Xu"
date: "10/21/2020"
output:
...
##need to fill: If you mention some new methods which may be useful for you along with relevant reference that would be good.
...
b = -svm_model$rho
```
We first build the SVM and use radial basis kernel to train.

Then we can use the trainning svm to test.
```{r}
...
##  Compare models, results, and maybe consider the effect of sample size